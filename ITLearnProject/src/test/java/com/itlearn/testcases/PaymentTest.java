...
public class PaymentTest extends BaseTest{
	...
	public void payment()
	{
		...
		pg.paymentProcess(ReadExcelFile.getCellValue(fileName, "payment", 0, 0), ReadExcelFile.getCellValue(fileName, "payment", 0, 1), ReadExcelFile.getCellValue(fileName, "payment", 0, 2));
	}
}
